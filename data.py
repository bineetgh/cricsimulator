...
players['West Indies'] = ["S Hope", "R Chase", "K Carty", "M Forde", "R Shepherd", "A Athanaze", "K Hogde", "A Joseph", "K Ottely", "S Joseph", "O Thomas"] 
...
players['South Africa'] = ["R Hendricks", "A Markram", "D Elgar", "H Klassan", "D Miller", "M Jansen", "G Coetzee", "K Maharaj", "T Shamsi", "K Rabada", "L Ngidi"] 
players['Team X'] = ["Aviral M", "Aarav Singh", "Vedant K", "B Mishra", "A Mishra", "R Singh", "T John", "S Samson", "M Stacky", "KL Yadav", "AB Sharma"] 
...
wickets = ["Caught", "Stumped", "Bowled", "Run Out", "LBW"]
